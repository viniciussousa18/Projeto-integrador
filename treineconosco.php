...
UPGRADE PARA O PLANO BLACK PAGANDO APENAS R$89,90/MÊS!</p>
        <center>
        <h1 class="card-title">Gostaria De Treinar Conosco?</h1>
    <div class="col-md-5">
    <img src="img/foto.png" class="card-img" alt=""> <br> <br>
        <p class="card-text"><small class="text-muted">FAÇA SUA PRÉ-INSCRIÇÃO</small></p>
        <p class="card-text">Possuímos a maior e melhor estrutura da região para lhe oferecer um maior conforto. São 1.200 m² divididos em diversas áreas. Oferecemos instalações modernas e confortáveis, contamos com: Salas de musculação, ginástica, lutas e pilates, área de convivência, lanchonete Fit, loja moda fitness, loja de suplementos alimentares e produtos naturais.</p>
  <p class="card-text">Cadastre-se abaixo e receba em seu e-mail um FREE PASS para realizar 1 treino gratuito em nossa academia. Venha se surpreender! <br> <br>
  <div class="col-sm">
                    <fieldset>
            Nome:
            <br>
        ...
        Telefone:
            ...
            <input type= "submit" value ="ADQUIRA SEU FREE PASS">
